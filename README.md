...
- [x] Box 1: Create a single Service Bus Namespace. Box 2: Create a single Service Bus Topic.
...
- [x] az monitor metrics alert create Cn alert Cg … - -scopes … - -condition "avg Percentage CPU > 800".
